...
# Mapping: prod=c-22, beta=c-23, alpha=(none)
# Last promotion: 2026-02-15 prod←c-22, beta←c-23 (typeahead + noise filters)
...
unleashed-beta() {
  _unleashed_run src/unleashed-c-23.py --sentinel-shadow --mirror --friction "$@"
}
